                  ...
                  <div class="col-md-2">
                    ...
                    <div class="col-md-4">                                        
                        <div class="input-group input-medium date date-picker"
                            ...
                            <input type="date" class="form-control" name="from" value="<?php echo isset($_POST["from"]) ? $_POST["from"] : ''; ?>" required>
                            <span class="input-group-addon"> to </span>
                            <input type="date" class="form-control" name="to" value="<?php echo isset($_POST["to"]) ? $_POST["to"] : ''; ?>" required>
                        </div>
