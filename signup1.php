        ...
        <div class="content">
            ...
            <form class="register-form fade-in-right"  method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username-register" /> 
                </div>
                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9">Email</label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="email-register" /> </div>
                <div class="form-group d-inline-block">
                    ...
                    <!-- <input class="form-control placeholder-no-fix input-small pull-left" type="number" placeholder="Age" name="age" /> --> 
                        <input class="form-control form-control-inline input-small date date-picker placeholder-no-fix pull-left" size="16" type="text" placeholder="MM/DD/YYYY" name="DOB" data-provide="date-picker">
                </div>
               <div class="form-group d-inline-block">
                    <label class="control-label visible-ie8 visible-ie9">Gender</label>
                    <select name="gender" class="form-control input-medium pull-right clearfix" id="gender-list" name="gender">
                ...
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="register_password" placeholder="Password" name="password-register" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Re-type Your Password</label>
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" name="rpassword-register" /> </div>
